...
train_reward_filename = os.path.join(base_log_dir, 'Dec15_TD3_Collisionchecking_training_rewards_whole.txt')

end_effector_position_filename = os.path.join(base_log_dir, 'Dec15_TD3_Effector_trajectory_baseline.txt')
