...
train_reward_filename = os.path.join(base_log_dir, 'Nov28th_Collisionchecking_training_rewards_whole.txt')

end_effector_position_filename = os.path.join(base_log_dir, 'Nov28thEnd_Effector_trajectory_baseline.txt')
