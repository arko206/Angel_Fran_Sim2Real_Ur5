...
collision_contact_filename = os.path.join(base_log_dir, 'Dec9th_Test_Collision_Contact.txt')
...
class StateValidity():
    ...
    def checkCollision(self):
        ...
        # Call the service and get the ALLOWED COLLISION MATRIX
        # of the corresponding planning scene
        response = self.get_planning_scene(self.request)

        

        # Extract and print the allowed collision matrix
