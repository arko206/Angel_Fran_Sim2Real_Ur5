...
train_reward_filename = os.path.join(base_log_dir, 'Dec9th_Collisionchecking_training_rewards_whole.txt')

end_effector_position_filename = os.path.join(base_log_dir, 'Dec9th_Effector_trajectory_baseline.txt')
    ...
    for epoch in range(0, 2000):
        ...
        while not_done:
            if args.model_name == 'SAC':
                ...
                action = (model.act(state, sample=False)).clip(-max_action, max_action)
