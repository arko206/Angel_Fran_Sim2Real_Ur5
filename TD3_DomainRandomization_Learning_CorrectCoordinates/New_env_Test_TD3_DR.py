...
test_reward_filename = os.path.join(base_log_dir, 'DRTD3_17thDecember_rewards_whole_TestOnly.txt')
end_effector_position_filename_test = os.path.join(base_log_dir, 'DRTD3_17thDecember_End_Effector_trajectory_baseline.txt')
...
def train(args, env, model):
    ...
    if args.pre_train:
        try:
            base_path = "/home/robocupathome/rosur5_ws/src/contexualaffordance/DRLMODELTD3TD3/17_12_2024/epoch_2000/"
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--model_date', default='/28_11_2024')
    # #Folder stored with trained model weights, which are used for transfer learning
    # parser.add_argument('--model_date_', default='/28_11_2024')
