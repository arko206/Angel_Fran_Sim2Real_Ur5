...
class TD3(object):
	...
	def load(self, model_dir, model_name):
		self.critic.load_state_dict(torch.load(model_dir+model_name+"_critic.pth"))
		self.critic_optimizer.load_state_dict(torch.load(model_dir+model_name+"_critic_optimizer.pth"))
		self.critic_target = copy.deepcopy(self.critic)

		self.actor.load_state_dict(torch.load( model_dir+model_name+"_actor.pth"))
		self.actor_optimizer.load_state_dict(torch.load(model_dir+model_name+"_actor_optimizer.pth"))
		self.actor_target = copy.deepcopy(self.actor)
