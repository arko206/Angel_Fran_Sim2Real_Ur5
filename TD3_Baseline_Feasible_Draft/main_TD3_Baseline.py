...
train_reward_filename = os.path.join(base_log_dir, '25thNov_Collisionchecking_training_rewards_whole.txt')

end_effector_position_filename = os.path.join(base_log_dir, 'End_Effector_trajectory_baseline.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_date', default='/25_11_2024')
    #Folder stored with trained model weights, which are used for transfer learning
    parser.add_argument('--model_date_', default='/25_11_2024')
